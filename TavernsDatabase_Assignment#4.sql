/*
	Miles Technologies Data Bootcamp Assignment #4:
	...
	8. Write a query that returns guests that stay within a date range. Please remember that guests can stay for more 
	than one night AND not all of the dates they stay have to be in that range (just some of them)
...
/* Not sure how to acomplish this requirement */